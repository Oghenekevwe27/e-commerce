    ...
    <div>
           ...
           <div className="col-md">
             <div className="firstshoe ">
                ...
                <div className="shoespic ">
                  <img class="shoespic-item" src="/image/Product-Picture-01.png" alt="" />
                  <img class="shoespic-item" src="/image/Product-Picture-02.png" alt="" />
                  <img class="shoespic-item" src="/image/Product-Picture-03.png" alt="" />
                  <img class="shoespic-item" src="/image/Product-Picture-04.png" alt="" />
                </div>
      ...
      <h5 class='nav-words'>Nike Airmax 270 React</h5>
       <div>
        ...
        <p>0 review</p>
        <button class="btn"type="button"  data-bs-toggle="modal" data-bs-target="#exampleModal" >Submit a Review</button>
              </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form>
       <Rating/>
       <div class="content">
                                <h5 for='content'class="unknown">Content</h5>
        ...
        <button type="button" class="btn btn-primary">submit</button>
         ...
         <div  className="pricing">
           <div className="pricing-line1" >
             <p className="pricing-line1-1">$299,43</p><p className="pricing-line1-2">$534,33</p><p className="pricing-line1-3">24% Off</p>
           </div>
           <div className="pricing-line1">
             <p className="pricing-line1-5">Availability:</p> <div className="pricingdiv"> <p className="pricing-line1-6">In stock</p> </div>       
             </div>
             <div className="pricing-line1">
             <p className="pricing-line1-5">Category:</p><p className="pricing-line1-6">Accessories</p>     
             </div>
             <div className="pricing-line1">
             ...
             <p>size</p> <div className="siseselect">
